...
-   `components/Core/WaterScene/index.tsx`
-   `components/Core/WaterScene/shaders/common.ts`
-   `components/Core/WaterScene/shaders/godray.ts`
-   `components/Core/WaterScene/shaders/ripple.ts`
-   `components/Core/WaterScene/shaders/terrain.ts`
-   `components/Core/WaterScene/shaders/water.ts`
-   `components/Core/WaterScene/utils/createSandTexture.ts`
-   `components/Package/CodePanel.tsx`
-   `components/Package/ConsolePanel.tsx`
-   `components/Package/ControlPanel/index.tsx`
-   `components/Package/ControlPanel/ElementProps.tsx`
-   `components/Package/ControlPanel/Inspector.tsx`
-   `components/Package/ControlPanel/InteractionState.tsx`
-   `components/Package/ControlPanel/WaterSimulation.tsx`
